...
<header>
		<nav class="navbar navbar-toggleable-md navbar-dark bg-faded">
			<div>
				<b> <a class="navbar-brand" href="recipe-list.jsp"> <img
			...
			<ul class="navbar-nav ml-auto">
				<li>
					...
					<a href="/Cook-chef2/Logout" style="color: white;">Logout</a> <%
 } else {
 %> <a href="/Cook-chef2/login.jsp" style="color: white;">Login</a> <%
 }
 %>
				</li>
			</ul>
        ...
        <section class="recipes-container">
			...
			%>
				...
				%>
					...
					<a  class="card"
					href="recipe-info.jsp?id=<%=rm.getId()%>"
			...
			%>
                ...
                <!-- <a href="singlerecipe.html" class="recipe">
                    <img src="./assets/mainPhoto_banarasiyathandai1.jpg" alt="banarasiyathandai" class="img recipe-img"/>
                    <h5>Banarasiya Thandai</h5>
                    <p>Cook time: 15min</p>
    ...
    <footer class="page-footer">
        ...
        <span class="footer-logo">
            Cook Chef</span>
        built by <a href="#">Mrudul Tora & Preetam Pal</a></p>
    </footer>
