		...
		<nav class="navbar navbar-toggleable-md navbar-dark bg-faded">
			...
			<ul class="navbar-nav ml-auto">
				<li>
					...
					%> <a href="/Cook-chef2/EditOrUpdate?action=edit&id=<%=id%>"
					style="color: white;" align="right">Edit</a><br> <a
					href="/Cook-chef2/EditOrUpdate?action=delete&id=<%=id%>"
	...
	<div class="card"
		...
		<article style="padding: 15px;" charset="UTF-8">
			...
			<br><br>
				...
				alt="Food Image"
				style="float:right;margin-right:50px;width: 600px; height: 400px; border: 2px solid #072A6C; padding: 2px">
